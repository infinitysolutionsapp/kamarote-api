...
class ConfigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create config" do
    assert_difference("Config.count") do
      post configs_url, params: { config: { banner_url: @config.banner_url, main_title: @config.main_title, second_title: @config.second_title } }, as: :json
    end
  ...
  test "should update config" do
    patch config_url(@config), params: { config: { banner_url: @config.banner_url, main_title: @config.main_title, second_title: @config.second_title } }, as: :json
    assert_response :success
  end
